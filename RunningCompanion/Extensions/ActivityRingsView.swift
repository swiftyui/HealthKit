...
extension Color {
    ...
    public static var darkGreen: Color {
        return Color(hue: 0.327, saturation: 1.0, brightness: 0.586)
    }
    
    public static var lightGreen: Color {
        return Color(hue: 0.327, saturation: 0.719, brightness: 0.712)
    }
    
    public static var darkBlue: Color {
        return Color(hue: 0.573, saturation: 1.0, brightness: 0.598)
    }
    
    public static var lightBlue: Color {
        return Color(hue: 0.573, saturation: 0.729, brightness: 0.788)
    }
